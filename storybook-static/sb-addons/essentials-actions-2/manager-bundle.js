try {
  (() => {
    ...
    var Ua = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: Fa,
        ARGTYPES_INFO_RESPONSE: Ha,
        CHANNEL_CREATED: ja,
        CHANNEL_WS_DISCONNECT: za,
        CONFIG_ERROR: ka,
        ...
        FILE_COMPONENT_SEARCH_RESPONSE: Xa,
        FORCE_REMOUNT: qa,
        FORCE_RE_RENDER: Ka,
        GLOBALS_UPDATED: Za,
        NAVIGATE_URL: Qa,
        ...
        TESTING_MODULE_CRASH_REPORT: Uo,
        TESTING_MODULE_PROGRESS_REPORT: Fo,
        TESTING_MODULE_RUN_ALL_REQUEST: Ho,
        TESTING_MODULE_RUN_REQUEST: jo,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: zo,
    ...
    function Ue(e, t, r) {
      for (r of e.keys()) if (w(r, t)) return r;
    }
    function w(e, t) {
      var r, n, a;
      if (e === t) return !0;
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Array) {
          if ((n = e.length) === t.length) for (; n-- && w(e[n], t[n]); );
          return n === -1;
        }
        if (r === Set) {
    ...
    function At(e, t, r, n) {
      if (
        ...
        return n >= 1 ? V(e, t, r) : 'rgba(' + U(e, t, r) + ',' + n + ')';
      if (typeof e == 'object' && t === void 0 && r === void 0 && n === void 0)
        return e.alpha >= 1
          ? V(e.hue, e.saturation, e.lightness)
          : 'rgba(' + U(e.hue, e.saturation, e.lightness) + ',' + e.alpha + ')';
      throw new T(2);
    }
    function oe(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number')
    ...
    var Yt = 'actions',
        ...
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of tt(t))
            !Kt.call(e, a) &&
              ...
              pe(e, a, {
                get: () => t[a],
                enumerable: !(n = Xt(t, a)) || n.enumerable,
              });
        return e;
      },
      er = (e, t, r) => (
      ...
      X = {};
    Zt(X, { chromeDark: () => ar, chromeLight: () => or });
    var ar = {
          ...
          i.forEach(l => {
            let u = l.split('.'),
              c = (p, f, d) => {
                ...
                let E = u[d];
                if (d === 0) J(p, t) && (E === q || E === qe) && c(p, q, d + 1);
                else if (E === qe)
    ...
    var ce = ({ data: e }) => {
        ...
        if (
          ...
          return o.createElement(F, { object: r });
        if (Array.isArray(r)) {
          let n = t.arrayMaxProperties,
            a = r
              .slice(0, n)
              .map((s, l) => o.createElement(F, { key: l, object: s }));
          r.length > n &&
          ...
          return o.createElement(
            ...
            o.createElement('span', { style: t.preview }, '[', Ke(a, ', '), ']')
          );
        } else {
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Dr = B.div(({ theme: e }) => ({
        backgroundColor: Xe(0.5, e.appBorderColor),
    ...
    var Br = B(lt)({ margin: 0, padding: '10px 5px 20px' }),
      ...
      jr = class extends Te {
        ...
        render() {
          ...
          return t ? o.createElement(Fr, { ...r }) : null;
        }
      };
    function zr() {
      let [{ count: e }, t] = De(H, { count: 0 });
      return (
        Me({
          [se]: () => {
