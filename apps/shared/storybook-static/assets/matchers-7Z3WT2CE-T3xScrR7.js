...
function je() {
  let e = new Map();
  for (let [r, n] of Object.entries(P)) {
  ...
  return (
    ...
    Object.defineProperties(P, {
      ...
      hexToAnsi256: {
        value: r => P.rgbToAnsi256(...P.hexToRgb(r)),
        enumerable: !1,
      },
      ansi256ToAnsi: {
        value(r) {
      ...
      rgbToAnsi: {
        value: (r, n, i) => P.ansi256ToAnsi(P.rgbToAnsi256(r, n, i)),
        enumerable: !1,
      },
      hexToAnsi: {
        value: r => P.ansi256ToAnsi(P.hexToAnsi256(r)),
        enumerable: !1,
      },
    }),
    P
...
var W = qe,
  ...
  F = (e, r) =>
    function () {
      return (
        r || (0, e[Re(e)[0]])((r = { exports: {} }).exports, r),
        r.exports
      );
    },
  Je = (e, r, n, i) => {
...
${U}`
      ...
      function z(t, b, T, M, S, f) {
        ...
        let v = R(t, b.printFunctionName, b.escapeRegex, b.escapeString);
          ...
          return {
            ...
            min:
              (f = t == null ? void 0 : t.min) !== null && f !== void 0
                ...
                : k.min,
            plugins:
              (N = t == null ? void 0 : t.plugins) !== null && N !== void 0
                ? N
                : k.plugins,
            printBasicPrototype:
              (v = t == null ? void 0 : t.printBasicPrototype) !== null &&
              v !== void 0
                ? v
                : !0,
