import { g as b } from './_commonjsHelpers-Cpj98o6Y.js';
function Y(t, e) {
...
function K(t) {
  return t === null || typeof t != 'object'
    ? null
    : ((t = (d && t[d]) || t['@@iterator']), typeof t == 'function' ? t : null);
}
var h = {
    isMounted: function () {
      return !1;
...
function m(t, e, r, n, u, f) {
  return (
    (r = f.ref),
    { $$typeof: E, type: t, key: e, ref: r !== void 0 ? r : null, props: f }
  );
}
function B(t, e) {
  return m(t.type, e, void 0, void 0, void 0, t.props);
}
function T(t) {
...
function a(t, e, r, n, u) {
      ...
      case 'object':
        switch (t.$$typeof) {
          ...
          case x:
            ...
            break;
          case O:
            return ((s = t._init), a(s(t._payload), e, r, n, u));
        }
    }
  if (s)
    return (
  ...
  if (C(t))
    for (var c = 0; c < t.length; c++)
      ((n = t[c]), (f = p + y(n, c)), (s += a(n, e, r, f, u)));
  else if (((c = K(t)), typeof c == 'function'))
    for (t = c.call(t), c = 0; !(n = t.next()).done; )
      ((n = n.value), (f = p + y(n, c++)), (s += a(n, e, r, f, u)));
  else if (f === 'object') {
    if (typeof t.then == 'function') return a(Q(t), e, r, n, u);
    throw (
      (e = String(t)),
      Error(
...
o.cloneElement = function (t, e, r) {
  ...
  return m(t.type, u, void 0, void 0, f, n);
};
...
o.createElement = function (t, e, r) {
  ...
  if (t && t.defaultProps)
    for (n in ((s = t.defaultProps), s)) u[n] === void 0 && (u[n] = s[n]);
  return m(t, f, void 0, void 0, null, u);
};
...
var N = S.exports;
const J = b(N),
  F = Y({ __proto__: null, default: J }, [N]);
export { J as R, F as a, N as r };
